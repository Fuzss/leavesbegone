...
public class ServerConfig implements ConfigCore {
    ...
    @Config.IntRange(min = 0) public int minimumDecayTicks = 5;
    @Config(description = "Maximum ticks it takes for leaves to decay.")
    @Config.IntRange(min = 0) public int maximumDecayTicks = 20;
    @Config(description = "Leaves not attached to their own kind will decay.")
